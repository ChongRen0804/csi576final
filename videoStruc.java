...
public class videoStruc {
	...
	public void readAndextractSound() throws PlayWaveException, FileNotFoundException, IOException{
		...
		if(type == 0)
			soundFileName= "/Users/rc/Desktop/576final/db/" + videoname + "/" + videoname + ".wav";
		else
			soundFileName= "/Users/rc/Desktop/576final/query/" + videoname + "/" + videoname  + ".wav";
		try {
	...
	public void readAndextractVideo() {
		for(int i = 0;i < framenum;i++) {
			...
			String imgpath;
			if(type == 0)
				imgpath= "/Users/rc/Desktop/576final/db/" + videoname + "/" + videoname + num + ".rgb";
			else
				imgpath= "/Users/rc/Desktop/576final/query/" + videoname + "/" + videoname + "_" + num + ".rgb";
				//imgpath= "/Users/rc/Desktop/576final/query/" + videoname + "/" + videoname + num + ".rgb";
